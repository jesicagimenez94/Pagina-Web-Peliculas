...
<div class="fixed">
  ...
  <nav class="navbar navbar-dark">
    ...
    <a style="float:left" class="navbar-brand" href="index.php"><img src="assets/img/logoo.jpg" style="width: 150px;height:60px;border-radius: 10px"><i style="margin-left:20px">Peliculas Jesica</i></a>
