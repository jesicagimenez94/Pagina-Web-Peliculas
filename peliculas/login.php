        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12" align="center" style="padding-top:10px;">
                <a href="index.php"><img src="assets/img/logoo.jpg" style="width:150px;height:70px;border-radius:20px"></a>
            </div>
          ...
          <?php if (isset($_GET['pagina'])&& $_GET['pagina']==1) {
                ...
                require("conexion.php");
                    ...
                    $password=$_POST['contra'];
                        $consulta= mysqli_query($conexion,"SELECT * FROM users where email='$usuario' and contrasenia='$password'"); 
