...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-11-2020 a las 23:30:04
...
(27, 'jjjjjjj', 202, 8.2, 300, 'accion', 'jjjjjjjj', 'kkkkkkkk');
...
values (OLD.id_movie,NEW.titulo,now()) ;
END
$$
DELIMITER ;
DELIMITER $$
...
--
ALTER TABLE `movies`
  MODIFY `id_movie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
